...
class WaitingEventsListView(ListView):

    template_name = "calendarapp/waiting_approval_events_list.html"
    model = Event

    def get_queryset(self):
        return Event.objects.get_waiting_aproval_events(user=self.request.user)
